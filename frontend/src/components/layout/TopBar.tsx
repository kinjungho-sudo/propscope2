  ...
  return (
    <div className="absolute top-3 left-3 right-3 z-50 flex items-center gap-2 pointer-events-none">
      ...
      <div className="relative flex-1 max-w-md pointer-events-auto">
        <div className="relative flex items-center bg-white/95 backdrop-blur-sm shadow-xl rounded-xl border border-slate-200">
      ...
      <select
        ...
        className="pointer-events-auto px-3 py-2.5 rounded-xl text-sm font-medium bg-white/95 backdrop-blur-sm border border-slate-200 text-slate-700 shadow-xl focus:outline-none focus:border-blue-400 cursor-pointer hover:bg-white"
      >
